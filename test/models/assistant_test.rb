...
class AssistantTest < ActiveSupport::TestCase
  ...
  test "errors get added to chat" do
    @assistant.expects(:get_model_provider).with("claude-sonnet-4-5-20250929").returns(@provider)
  ...
  test "responds with tool function calls" do
    @assistant.expects(:get_model_provider).with("claude-sonnet-4-5-20250929").returns(@provider).once
