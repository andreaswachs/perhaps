    ...
    private
      ...
      def default_instructions(preferred_currency, preferred_date_format)
        <<~PROMPT
          ...
          You are a friendly financial assistant for an open source personal finance application called "Perhaps", which is short for "Perhaps Finance".
          ...
          Perhaps is a multi-currency app where each user has a "preferred currency" setting.
