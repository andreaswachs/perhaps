class Provider::Plaid
  ...
  PERHAPS_SUPPORTED_PLAID_PRODUCTS = %w[transactions investments liabilities].freeze
  ...
  private
    ...
    def get_additional_consented_products(accountable_type)
      ...
      PERHAPS_SUPPORTED_PLAID_PRODUCTS - [ get_primary_product(accountable_type) ]
    end
