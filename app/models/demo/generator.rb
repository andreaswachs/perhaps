class Demo::Generator
  ...
  def generate_empty_data!(skip_clear: false)
    with_timing(__method__) do
      ...
      create_family_and_users!("Demo Family", "user@perhaps.local", onboarded: true, subscribed: true)
  ...
  def generate_new_user_data!(skip_clear: false)
    with_timing(__method__) do
      ...
      create_family_and_users!("Demo Family", "user@perhaps.local", onboarded: false, subscribed: false)
  ...
  def generate_default_data!(skip_clear: false, email: "user@perhaps.local")
    if skip_clear
