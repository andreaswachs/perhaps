class PagesController < ApplicationController
  ...
  def changelog
    ...
    if @release_notes.nil?
      @release_notes = {
        avatar: "https://github.com/perhaps-finance.png",
        username: "perhaps-finance",
        name: "Release notes unavailable",
        published_at: Date.current,
        body: "<p>Unable to fetch the latest release notes at this time. Please check back later or visit our <a href='https://github.com/perhaps-finance/perhaps/releases' target='_blank'>GitHub releases page</a> directly.</p>"
      }
    end
