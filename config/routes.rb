...
Rails.application.routes.draw do
  ...
  # Sidekiq health status (for monitoring dashboards via web server)
  ...
  get "privacy", to: redirect("https://perhapsfinance.com/privacy")
  get "terms", to: redirect("https://perhapsfinance.com/tos")
